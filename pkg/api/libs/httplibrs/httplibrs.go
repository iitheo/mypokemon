...
func Response(res http.ResponseWriter, resp httpresppokemon.HttpResponse) {
...
func Response400(res http.ResponseWriter, resp httpresppokemon.HttpResponse) {
...
func Response401(res http.ResponseWriter, resp httpresppokemon.HttpResponse) {
...
func Response404(res http.ResponseWriter, resp httpresppokemon.HttpResponse) {
...
func Response500(res http.ResponseWriter, resp httpresppokemon.HttpResponse) {
