...
type TranslateRequestVM struct {
	Text string `json:"text"`
}

type TranslateResponseVM struct {
	Success struct {
...
type PokemonSpeciesResponseVM struct {
	Name                  string `json:"name"`
...
type CreateFunDescription struct {
	Text string `json:"text"`
}
